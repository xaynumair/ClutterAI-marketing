    ...
    <div className="root">
          ...
          <div className="body">
            <section>
              ...
              <ul>
                ...
                <li>Address: 30 N Gould St Ste N, Sheridan, Wyoming 82801, United States</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul>
                <li>Connect third-party services (Google Drive, Gmail, Google Calendar, Slack, Notion, GitHub, GitLab, Linear, Jira, Confluence, Trello, Airtable, Zendesk, and others)</li>
                <li>Search your connected content using natural language queries and receive AI-generated answers with links to their sources</li>
                <li>Keep connected content up to date automatically, including real-time updates from supported services</li>
                <li>Ask questions from within Slack by mentioning or messaging the ClutterAI app</li>
                <li>Use Forge, a technical workspace that generates files you can edit and save to your workspace</li>
                <li>Use automated agents (including Triage, Digest, and Pulse) that summarise and prioritise activity across your connected services</li>
                <li>Create and search your own notes alongside your connected content</li>
            ...
            <section>
              ...
              <p>
                ...
                of Wyoming and the applicable federal laws of the United States of America, without
                regard to conflict of law principles. ClutterAI is organised under the laws of the
                State of Wyoming with its registered office at 30 N Gould St Ste N, Sheridan,
                Wyoming 82801, United States.
              </p>
              <p>
                You agree that any dispute arising out of or relating to these Terms or the Service
                shall be brought exclusively in the state or federal courts located in the State of
                Wyoming, United States of America, and you consent to the personal jurisdiction of
                those courts.
              </p>
              <p>
      ...
      <style jsx>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Alternating surfaces — same two shades as the home page */
